...
import WooCommerceSetting from '@/containers/Setting/WooCommerceSetting.vue';
...
describe('WooCommerceSetting test', () => {
  let store;
  let getters;
  let mutations;
  let actions;
  ...
  it('should render', () => {
    ...
    const wrapper = shallowMount(WooCommerceSetting, {
      localVue,
      store,
    });
  ...
  it('should save form on save click', async () => {
    ...
    expect(actions.updateSetting).toHaveBeenCalledWith(expect.objectContaining({}), 'woocommerce');
  });
