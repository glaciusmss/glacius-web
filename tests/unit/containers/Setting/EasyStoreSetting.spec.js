...
import EasyStoreSetting from '@/containers/Setting/EasyStoreSetting.vue';
...
describe('EasyStoreSetting test', () => {
  let store;
  let getters;
  let mutations;
  let actions;
  ...
  it('should render', () => {
    ...
    const wrapper = shallowMount(EasyStoreSetting, {
      localVue,
      store,
    });
  ...
  it('should save form on save click', async () => {
    ...
    expect(actions.updateSetting).toHaveBeenCalledWith(expect.objectContaining({}), 'easystore');
  });
